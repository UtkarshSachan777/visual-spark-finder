...
import { expandedIndianProducts } from "./expandedIndianProducts";
...
export const allProducts = [...allIndianProducts, ...expandedIndianProducts, ...mockProducts, ...additionalProducts];